...
namespace Zaphat.Core
{
    public abstract class Buffer
    {
        ...
        /// <summary>
        /// Set the vertex attribute divisor for the attribute index. 0 = Every vertex, 1 = At the start of each instance, 2 = At the start of every second instance, and so on.
        /// </summary>
